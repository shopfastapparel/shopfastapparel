...
msg['Subject'] = 'Your Fast Apparel Invoice (Camp Runamuck 2026)'
    ...
    <table class="main" width="100%" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td class="content">
          ...
          <p>Hi Joan,</p>
          <p>Thank you for finalizing the details for your <strong>"Camp Runamuck 2026"</strong> custom tees! We are super excited to get these printed and into your hands.</p>
          
          <p>Below is the link to your official invoice. Once the invoice is settled, your order will instantly be placed into our production queue!</p>
          
          <div class="cta-container">
            <a href="https://my.freshbooks.com/#/link/lIXXMSqe2QF8eN" class="cta-button">View & Pay Your Invoice</a>
          </div>
          
          <p>If you have any last-minute questions before paying, feel free to reply directly to this email!</p>
          <p>Talk soon!</p>
        </td>
      </tr>
      <tr>
...
try:
    ...
    server.quit()
    print("Successfully sent the invoice email to Joan.")
