...
md_content = """Hi Chevis,

Thank you for requesting a quote from Fast Apparel! We received your artwork and see that you are looking for Men's Large shirts in Green with a full front center print. 
  ...
  <tbody>
    <tr style="border-bottom: 1px solid #e5e7eb;">
      <td style="padding: 12px; color: #111827;">
        <strong>Custom T-Shirts (Men's Large, Green)</strong><br>
        <span style="font-size: 12px; color: #6b7280;">Includes Premium Soft-Style Blank & Full-Color DTF Print (Full Front Center)</span>
      </td>
...
If you'd like to move forward, please let us know exactly how many shirts you need. Once we have your final quantity, we'll send over an official invoice with the final total along with a digital mockup of your design on the green shirt for your approval before we start printing!
...
# Send the email to CHEVIS
params = {
    "from": from_email,
    "to": ["chevismj@gmail.com"],
    "subject": subject,
    "html": final_html
}

response = resend.Emails.send(params)
print("Final quote sent to Chevis successfully!")
